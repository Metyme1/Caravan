...
const initialRooms = [
  {
    ...
    price: "1500 / Night",
    description:
      "Our Standard Rooms are comfortable and well-equipped for a pleasant stay. They feature a cozy bed, modern amenities, and a serene ambiance.",
    characteristics: [
  ...
  },
  {
    ...
    price: "1800 / Night",
    description:
      "Our Twin Bed Rooms are spacious and perfect for two guests. They offer twin beds, a comfortable seating area, and beautiful views.",
    characteristics: [
  ...
  },
  {
    ...
    price: "1600 / Night",
    description:
      "Our Semi-Suite Rooms offer extra space and comfort for your stay. They include a cooking space for your convenience, along with all essential amenities.",
    characteristics: [
  ...
  },
  {
    ...
    price: "3000 / Night",
    description:
      "Our Suite Rooms provide luxury and comfort for a premium stay. They feature a separate salon, bedroom, two bathrooms, air conditioning, and a fully equipped kitchen.",
    characteristics: [
      { icon: "👥", label: "1-2 Persons" },
      { icon: "📶", label: "Free Wifi" },
      { icon: "🍽️", label: "Breakfast Included" },
...
const Rooms = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Rooms & Suites – Caravan Dire Hotel</title>
        <meta
          name="description"
          content="Explore a variety of rooms at Caravan Dire Hotel, including Standard, Twin Bed, Semi-suite, and Suite Rooms. Comfortable, modern, and affordable accommodation in Dire Dawa."
        />
        <meta
          name="keywords"
          content="Caravan Dire Hotel rooms, Dire Dawa hotel, hotel rooms Ethiopia, book hotel Dire Dawa"
        />
        <meta
          property="og:title"
          content="Rooms & Suites – Caravan Dire Hotel"
        />
        <meta
          property="og:description"
          content="Find the perfect room at Caravan Dire Hotel – whether you prefer a standard, semi-suite, twin, or luxury suite. All rooms include modern amenities."
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {rooms.map((room, index) => (
              ...
              >
                ...
                >
                  <p className="text-lg font-bold text-gray-700 mb-2 font-times">
                    {room.price}
                  </p>
                  <h3 className="text-2xl md:text-3xl mb-2 font-times">
                    {room.name}
                  </h3>
                  <p className="text-gray-600 mb-4 font-times">
                    {room.description}
                  </p>
                  <p className="text-gray-600 mb-4 font-times">
                  ...
                  <div className="flex flex-wrap items-center space-x-4 mb-4">
                    {room.characteristics.map((characteristic, idx) => (
                      <div
                        key={idx}
                        className="flex items-center space-x-2 mb-2 font-times"
                      >
                        <span role="img" aria-label="characteristic-icon">
                          {characteristic.icon}
                        </span>
        ...
        {isSuccessDialogVisible && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-8 rounded shadow-md text-center">
              <h2 className="text-2xl mb-4 font-times text-green-500">
