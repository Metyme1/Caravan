...
//               <div key={service.id} className="min-w-full md:min-w-1/2 lg:min-w-1/3 xl:min-w-1/4 bg-white shadow-md rounded-lg overflow-hidden">
...
//             ))}
//           </div>
//           <button className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-white text-gray-900 px-4 py-2 rounded-full shadow-lg hover:bg-gray-100 transition duration-300">❮</button>
//           <button className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-white text-gray-900 px-4 py-2 rounded-full shadow-lg hover:bg-gray-100 transition duration-300">❯</button>
//         </div>
//       </div>
//     </section>
