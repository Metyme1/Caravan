...
const ReservationForm = ({ room, onSuccess, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-8 bg-white rounded shadow-md">
      ...
      <div className="mb-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            value={phone}
            onChange={(e) => setPhone(e.target.value)}
            className="pl-10 w-full px-3 py-2 border rounded-lg font-times focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <p className="text-gray-700 font-times mb-4">Contact our team for more information: <a href="tel:+1234567890" className="text-blue-600 hover:underline">+1 (234) 567-890</a></p>
      <div className="flex justify-end">
        <button
          type="button"
          onClick={handleCancel}
